# control: 5 TTA alone CA1
# case: 5 Tg4510 CA1

# Version info: R 3.2.3, Biobase 2.30.0, GEOquery 2.40.0, limma 3.26.8
# R scripts generated  Mon Sep 18 15:20:33 EDT 2017
...
gsms <- "XXXXXXXXXXXXXXXXX11111XXXXXXXXXXXX00000XXXXXXXXXX"
sml <- c()
...
write.table(tT, file="Results/GSE57583_Tg4510vsTTAalone_CA1.csv", row.names=F, sep=",")
