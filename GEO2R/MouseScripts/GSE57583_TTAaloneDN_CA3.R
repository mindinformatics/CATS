...
# R scripts generated  Mon Sep 18 15:35:57 EDT 2017
...
gsms <- "XXXXXX00000XXXXXXXXXXXXXXXXXXXXXXXXXXXX11111XXXXX"
sml <- c()
...
write.table(tT, file="Results/GSE57583_TTAaloneDN_CA3.csv", row.names=F, sep=",")
