# control: 5 TTAalone DG samples
# case: 6 Tg4510 DG samples

# Version info: R 3.2.3, Biobase 2.30.0, GEOquery 2.40.0, limma 3.26.8
# R scripts generated  Mon Sep 18 15:43:04 EDT 2017
...
gsms <- "XXXXXXXXXXXXXXXXXXXXXXXXXXXX111111XXXXXXXXXX00000"
sml <- c()
...
write.table(tT, file="Results/GSE57583_Tg4510vsTTAalone_DG.csv", row.names=F, sep=",")
