...
# R scripts generated  Mon Sep 18 15:29:20 EDT 2017
...
gsms <- "XXXXXX00000XXXXXXXXXXX111111XXXXXXXXXXXXXXXXXXXXX"
sml <- c()
...
write.table(tT, file="Results/GSE57583_Tg4510DN_CA3.csv", row.names=F, sep=",")
