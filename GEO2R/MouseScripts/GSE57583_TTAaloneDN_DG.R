# control: 6 Double Negative DG
# case: 5 TTAalone DG

# Version info: R 3.2.3, Biobase 2.30.0, GEOquery 2.40.0, limma 3.26.8
# R scripts generated  Mon Sep 18 15:47:01 EDT 2017
...
gsms <- "XXXXXXXXXXX000000XXXXXXXXXXXXXXXXXXXXXXXXXXX11111"
sml <- c()
...
write.table(tT, file="Results/GSE57583_TTAaloneDN_DG.csv", row.names=F, sep=",")
