# mice age: ~4-6 months 
# contrast: tTA alone vs DN

# Version info: R 3.2.3, Biobase 2.30.0, GEOquery 2.40.0, limma 3.26.8
# R scripts generated  Fri Sep 15 12:51:06 EDT 2017
...
gsms <- paste0("11111111111111111111XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
...
write.table(tT, file="ResultsAgeStratified/ttaAloneDN_4to6months.csv", row.names=F, sep=",")
