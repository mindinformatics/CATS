...
# R scripts generated  Mon Sep 18 15:17:07 EDT 2017
...
gsms <- "000000XXXXXXXXXXX11111XXXXXXXXXXXXXXXXXXXXXXXXXXX"
sml <- c()
...
write.table(tT, file="Results/GSE57583_Tg4510DN_CA1.csv", row.names=F, sep=",")
